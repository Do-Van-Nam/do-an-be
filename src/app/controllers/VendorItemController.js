...
const createVendorItem = async (req, res) => {
    const {accId, name, type,description,imgLink,typeVendor,priceSell,priceRent,periodRent} = req.body;
    try {
        ...
        const newVendorItem = new VendorItem({accId, name,periodRent, type,description,imgLink,typeVendor,priceSell,priceRent});
...
const updateVendorItem = async (req, res) => {
    ...
    try {
        const updatedVendorItem = await VendorItem.findByIdAndUpdate(
            id,
            { accId, name, type,description,imgLink,typeVendor,priceSell,priceRent,periodRent},
            { new: true }
        );
